...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	SetCurrentDirectory(Library::Utility::ExecutableDirectory().c_str());
    ...
    // Register class and create window
    {
		...
		auto getWidth = [&]()
		{
			return g_game->GetWindowWidth();
		};

		auto getHeight = [&]()
		{
			return g_game->GetWindowHeight();
		};


		g_game.reset(new GameRenderer(getWindow, getWidth, getHeight));
